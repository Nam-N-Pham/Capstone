...
namespace Capstone.Controllers
{
    ...
    public class RestaurantsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Restaurant>>> GetRestaurants(string filter)
        {
            ...
            if (filter == null){
                return await _context.Restaurants.OrderBy(row => row.Id).Include(restaurant => restaurant.Favorites).ToListAsync();
            }
            else{
                return await _context.Restaurants.OrderBy(row => row.Id)
                                                .Include(restaurant => restaurant.Favorites)
        ...
        public async Task<ActionResult<Restaurant>> GetRestaurant(int id)
        {
            ...
            var restaurant = await _context.Restaurants.Include(restaurant => restaurant.Favorites).Where(restaurant => restaurant.Id == id).FirstOrDefaultAsync();
